...
ActiveRecord::Schema.define(version: 2020_12_03_073819) do
  ...
  create_table "buyer_addres", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buy_item_id"], name: "index_buyer_addres_on_buy_item_id"
  end
  ...
  add_foreign_key "buyer_addres", "buy_items"
